          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.stretch, //stretch : mengikuti layar, kanan kiri
                children: [
                  _buildLogo(),
                  SizedBox(height: 32),
                  _buildTitle(),
                  ...
                  _buildSubTitle(),
                  SizedBox(height: 48),
                  child // utk manggil text field di register screen
                ],
              ),
            ),
          ),
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            blurRadius: 10, // blur nya ke semua tepi
            offset: Offset(0, 4)
          )
        ]
      ),
