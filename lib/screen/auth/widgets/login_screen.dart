...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try { // kalo benar blog try akan dijalankan sehingga bisa masuk ke home page
      await _authService.signInWithEmailAndPassword(
        _emailController.text.trim(),
        _passwordController.text.trim()
      );
    } catch (e) {
      if (mounted) { // kalo error
  ...
  void dispose() {
    ...
    super.dispose(); // memastikan tidak ada captche
  }
        ...
        children: [
          Card(
            ...
            child: Padding(
              ...
              child: Form( // mulai membuat kotak
                key: _formKey,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: const Color.fromARGB(255, 252, 246, 246),
